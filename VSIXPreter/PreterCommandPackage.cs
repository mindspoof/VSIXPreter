...
namespace VSIXPreter
{
    ...
    public sealed class PreterCommandPackage : AsyncPackage
    {
        /// <summary>
        /// PreterCommandPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "6e3f9edb-4ca2-4a2e-aa75-804abc34bba7";
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await PreterCommand.InitializeAsync(this);
        }
        #endregion
    }
}
